...
window.GAME_CONFIG = {
  ...
  // Falas da Cena 4 (Varanda) — edite à vontade
  dialogoVaranda: [
  ...
  mensagemPresente: [
    "Parabéns pelo seu dia, minha princesa!",
    "Este não é apenas um presente de aniversário...",
    "Este é o nascimento do nosso próprio jogo, do nosso universo e de todos os mundos que ainda vamos construir juntos."
  ],

  textoFinal: "ESTE É APENAS O INÍCIO DO NOSSO PROJETO...",
  textoFinal2: "Feito com todo o amor do mundo para a minha princesa.",
  textoFinal3: "TO BE CONTINUED...",

  bilheteChave1: "Hoje o dia é todo seu. Cada cantinho deste lugar guarda um pedaço da nossa história. Vá até o corredor.",
